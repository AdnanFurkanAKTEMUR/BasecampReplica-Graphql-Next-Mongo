...
export default function Login() {
  ...
  const [values, setInputs] = useState({ user_email: "", user_password: "" })
    ...
    { error ? <div className='text-red-600'>Doğrulama başarısız oldu tekrar deneyin!</div> : ""}
      ...
      >
        <Form.Item
          ...
          <Input name="user_email" prefix={<UserOutlined className="site-form-item-icon" />} placeholder="Kullanıcı Adı" onChange={onValuesChange} />
        </Form.Item>
        ...
        <Form.Item 
          ...
          <Input name="user_password" type='password' prefix={<LockOutlined className="site-form-item-icon" />} placeholder="Şifre" onChange={onValuesChange} />
        </Form.Item>
