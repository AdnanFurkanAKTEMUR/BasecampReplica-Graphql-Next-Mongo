      ...
      <div className="max-w-sm bg-white rounded-lg shadow">
        <div className="p-5">
          ...
          <p className='mb-3 font-normal text-gray-700'>
            {props.todo.todo_owners?.map((owner: any) => {
              return <Tag color='green' className='ml-1 p-1'>
                <Image alt="example" src="https://source.unsplash.com/featured/20x20" className='rounded-full inline' width={20} height={20} /> {owner.user_name}
              </Tag>
            })}
          </p>
